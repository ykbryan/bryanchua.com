...
I build and scale technology organizations that deliver real business value—not just science projects. 

Currently, I serve as CTO & Director at GoPomelo & Digital China Group, helping enterprises navigate complex digital transformations across the SEA and China markets. My roots, however, are in the trenches of hyper-growth. As the former Co-founder and CTO of ShopBack, and through my time at Microsoft and Amazon, I've learned what it actually takes to take a product from zero to scale, and from scale to enterprise-grade sustainability.

**My core thesis: Pragmatic execution over hype.**
