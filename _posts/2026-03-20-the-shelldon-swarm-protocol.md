...
Our agents execute natively on dedicated nodes (macOS and Ubuntu). They have real terminal access, read/write permissions to actual file systems, and the ability to trigger real deployment pipelines. But giving AI native execution access is exactly how you get a "runaway developer." 
...
Our engineering swarm doesn't just write code; it operates like a rigorous factory floor. The core of the Shelldon Swarm Protocol is an enforced separation of duties. Builders cannot architect, and builders definitely cannot deploy. 
